...
import { IdentityproviderModalComponent } from './identity-provider/identityprovider-modal/identityprovider-modal.component';
...
@NgModule({
  ...
  entryComponents: [ProjectModalComponent, DbsourceModalComponent, IdentityproviderModalComponent, ConfirmModalComponent, MessageModalComponent, OrganisationModalComponent, ShareModalComponent]
})
