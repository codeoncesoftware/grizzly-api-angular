...
export class FunctionModalComponent implements OnInit {
  ...
  constructor( private changeDetectorRefs: ChangeDetectorRef,private translateService: AppTranslateService, private dialog: MatDialog, private fb: FormBuilder, private toaster: ToastrService, private functionService: FunctionService, private store: Store<FunctionState>, private formBuilder: FormBuilder, public dialogRefFunction: MatDialogRef<FunctionModalComponent>, @Inject(MAT_DIALOG_DATA) public data) {
  }
