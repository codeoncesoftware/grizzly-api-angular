...
export class FunctionComponent implements OnInit, AfterViewInit {
  ...
  constructor(private toaster: ToastrService, private functionService: FunctionService, private store: Store<FunctionState>, private dialog: MatDialog, private formBuilder: FormBuilder, private translateService: AppTranslateService, private changeDetectorRefs: ChangeDetectorRef, private confirmModalService: ConfirmModalService) { }
