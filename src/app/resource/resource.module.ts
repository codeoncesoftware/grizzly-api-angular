...
@NgModule({
  ...
  entryComponents: [ResourceFunctionModalComponent, ImportModalComponent, SelectFilesModalComponent, ResourceModalComponent, ResourceInvalidModalComponent, ParamsModalComponent, CodesModalComponent]
})
