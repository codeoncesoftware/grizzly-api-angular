...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'grizzly-ai', component: GrizzlyAiComponent },
      { path: 'settings', component: SettingsComponent },
      { path: 'billing', component: BillingComponent },
      { path: 'project', loadChildren: () => import('../../project/project.module').then(m => m.ProjectModule) },
      { path: 'dbsource', loadChildren: () => import('../../dbsource/dbsource.module').then(m => m.DBSourceModule) },
      { path: 'identityprovider', loadChildren: () => import('../../identity-provider/identityprovider.module').then(m => m.IdentityProviderModule) },
