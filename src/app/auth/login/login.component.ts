...
export class LoginComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private store: Store<AuthState>, private router: Router, private dashboardService: DashboardService, private appTranslateService: AppTranslateService,private toasterService: ToastrService) {
  }
