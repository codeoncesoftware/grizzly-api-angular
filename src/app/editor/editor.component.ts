...
export class EditorComponent implements OnInit {
  ...
  constructor(private containerService: ContainerService, public dialog: MatDialog, private projectService: ProjectService, private toaster: ToastrService, private projectStore: Store<ProjectsState>, private confirmModalService: ConfirmModalService, private store: Store<ContainerState>, public el: ElementRef, private swaggerModalService: SwaggerModalService, private activeRoute: ActivatedRoute, private translateService: AppTranslateService, private router: Router, private editorService: EditorService, private sanitizer: DomSanitizer
  ) {
