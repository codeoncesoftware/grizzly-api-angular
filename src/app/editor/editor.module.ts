...
@NgModule({
  ...
  imports: [
    ...
    CodemirrorModule,
    CKEditorModule
  ], entryComponents: [ShareEditorComponent , JsonViewerComponent, SwaggerInfosModalComponent, ExportSwaggerModalComponent, AddModelComponent, GenerateModalComponent , EditorHistoryModalComponent],
