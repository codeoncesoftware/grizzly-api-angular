...
export class FunctionEffects {
  ...
  @Effect()
  createFunction = this.actions.pipe(
  ...
  @Effect()
  updateFunction = this.actions.pipe(
  ...
  @Effect()
  getAllFunctions = this.actions.pipe(
  ...
  @Effect()
  cloneFunction = this.actions.pipe(
  ...
  @Effect()
  deleteFunction = this.actions.pipe(
