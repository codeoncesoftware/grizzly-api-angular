...
export class IdentityProviderEffects {
  ...
  @Effect()
  loadIdentityProviders = this.actions.pipe(
  ...
  @Effect()
  createNewIdentityProvider = this.actions.pipe(
  ...
  @Effect()
  updateIdentityProvider = this.actions.pipe(
  ...
  @Effect()
  deleteIdentityProvider = this.actions.pipe(
